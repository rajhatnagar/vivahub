...
<body class="min-h-screen font-sans text-gray-800 bg-white">
        ...
        <div class="bg-white w-full max-w-sm rounded-3xl p-8 relative shadow-2xl mx-4">
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="email" name="email" placeholder="Enter your email" required class="w-full px-4 py-3 rounded-xl bg-gray-50 border border-gray-200 focus:outline-none focus:border-[#a67c52] text-sm">
                </div>
                <div>
                    <label class="block text-xs font-bold text-gray-700 mb-1 flex justify-between">
                        <span>Password</span>
                        <a href="#" class="text-[#a67c52] text-[10px]" onclick="alert('Password reset coming soon!')">Forgot password?</a>
                    </label>
            ...
            <a href="#" onclick="alert('Google Login coming soon!')" class="w-full border border-gray-300 py-3 rounded-full flex items-center justify-center gap-2 hover:bg-gray-50 transition-colors">
    ...
    <div id="partner-modal" class="fixed inset-0 z-50 flex items-center justify-center bg-black/80 hidden backdrop-blur-sm transition-opacity duration-300">
        <div class="bg-white w-full max-w-md rounded-3xl p-8 relative shadow-2xl mx-4 border border-gold-primary/20">
            <!-- Close Button -->
            <button onclick="togglePartnerModal()" class="absolute top-4 right-4 text-gray-400 hover:text-gray-600">
                <i data-lucide="x" class="w-6 h-6"></i>
            </button>
            ...
            <div class="flex justify-center mb-6 border-b border-gray-200">
                <button onclick="switchPartnerTab('login')" id="tab-partner-login" class="px-6 py-2 text-sm font-bold text-gold-primary border-b-2 border-gold-primary transition-colors">Login</button>
            ...
            <form id="form-partner-login" method="POST" action="{{ route('login') }}" class="space-y-4">
                ...
                <div>
                    <label class="block text-xs font-bold text-gray-700 mb-1">Email Address</label>
                    <input type="email" name="email" placeholder="Agency Email" required class="w-full px-4 py-3 rounded-xl bg-gray-50 border border-gray-200 focus:outline-none focus:border-gold-primary text-sm">
                </div>
                <div>
                    <label class="block text-xs font-bold text-gray-700 mb-1 flex justify-between">
                        <span>Password</span>
                        <a href="#" class="text-gold-primary text-[10px]" onclick="alert('Password reset coming soon!')">Forgot password?</a>
                    </label>
            ...
            <form id="form-partner-register" method="POST" action="{{ route('partner.register') }}" class="space-y-4 hidden">
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div>
                        ...
                        <input type="text" name="name" placeholder="Full Name" required class="w-full px-4 py-3 rounded-xl bg-gray-50 border border-gray-200 focus:outline-none focus:border-gold-primary text-sm">
                    </div>
                    <div>
                        <label class="block text-xs font-bold text-gray-700 mb-1">Agency Name</label>
                        <input type="text" name="agency_name" placeholder="Business Name" required class="w-full px-4 py-3 rounded-xl bg-gray-50 border border-gray-200 focus:outline-none focus:border-gold-primary text-sm">
                    </div>
                </div>
                
                <div>
                    <label class="block text-xs font-bold text-gray-700 mb-1">Email Address</label>
                    <input type="email" name="email" placeholder="Official Email" required class="w-full px-4 py-3 rounded-xl bg-gray-50 border border-gray-200 focus:outline-none focus:border-gold-primary text-sm">
                </div>

                <div>
                    <label class="block text-xs font-bold text-gray-700 mb-1">Phone Number</label>
                    <input type="tel" name="phone" placeholder="Contact Number" required class="w-full px-4 py-3 rounded-xl bg-gray-50 border border-gray-200 focus:outline-none focus:border-gold-primary text-sm">
                </div>

                <div class="grid grid-cols-2 gap-3">
                    <div>
                        <label class="block text-xs font-bold text-gray-700 mb-1">Password</label>
                        <input type="password" name="password" placeholder="******" required class="w-full px-4 py-3 rounded-xl bg-gray-50 border border-gray-200 focus:outline-none focus:border-gold-primary text-sm">
                    </div>
                    <div>
                        <label class="block text-xs font-bold text-gray-700 mb-1">Confirm</label>
                        <input type="password" name="password_confirmation" placeholder="******" required class="w-full px-4 py-3 rounded-xl bg-gray-50 border border-gray-200 focus:outline-none focus:border-gold-primary text-sm">
                    </div>
                </div>
    ...
    <header class="relative w-full overflow-hidden text-white min-h-[100vh] lg:min-h-[90vh] flex flex-col">
        ...
        <div class="relative z-20 flex justify-between items-start px-4 lg:px-8 pt-0">
            ...
            <!-- Partner Plan Badge - Added togglePartnerModal() here -->
            <button onclick="togglePartnerModal()" class="group flex flex-col items-center bg-gold-primary hover:bg-gold-dark text-white w-20 lg:w-24 py-3 lg:py-4 px-1 rounded-b-lg shadow-2xl transition-all duration-300 transform hover:translate-y-1 border-x border-b border-white/10 ring-1 ring-black/10 z-30 cursor-pointer">
    ...
    <script>
        ...
        function switchPartnerTab(tab) {
            const loginForm = document.getElementById('form-partner-login');
            const registerForm = document.getElementById('form-partner-register');
            const loginTab = document.getElementById('tab-partner-login');
            const registerTab = document.getElementById('tab-partner-register');

            if(tab === 'login') {
                loginForm.classList.remove('hidden');
                registerForm.classList.add('hidden');
                
                loginTab.classList.add('text-gold-primary', 'border-b-2', 'border-gold-primary');
                loginTab.classList.remove('text-gray-400', 'border-b-0'); 
                
                registerTab.classList.remove('text-gold-primary', 'border-b-2', 'border-gold-primary');
                registerTab.classList.add('text-gray-400');
            } else {
                loginForm.classList.add('hidden');
                registerForm.classList.remove('hidden');

                registerTab.classList.add('text-gold-primary', 'border-b-2', 'border-gold-primary');
                registerTab.classList.remove('text-gray-400');
                
                loginTab.classList.remove('text-gold-primary', 'border-b-2', 'border-gold-primary');
