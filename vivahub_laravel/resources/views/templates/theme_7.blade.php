...
<body class="selection:bg-amber-500/30 overflow-hidden" id="main-body">
    ...
    <section class="relative h-[100dvh] w-full overflow-hidden flex flex-col md:flex-row">
        ...
        <div class="absolute inset-0 z-0 bg-slate-950">
            ...
            <img id="hero-bg" src="{{ $invitation->data['hero_image'] ?? 'https://images.unsplash.com/photo-1532712938310-34cb3982ef74?auto=format&fit=crop&q=80&w=2070' }}" 
            ...
            <div class="glass-dark px-8 py-12 md:px-16 md:py-16 rounded-[2rem] max-w-2xl border-t border-b border-amber-500/40 relative animate-fade-in-up">
                ...
                <div class="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-12 text-sm md:text-base tracking-widest uppercase font-medium text-amber-400">
                    <div class="flex items-center gap-2">
                        ...
                        <span class="preview-hero-date">{{ \Carbon\Carbon::parse($invitation->data['date'] ?? '2026-12-12')->format('F jS, Y') }}</span>
                    </div>
                    <div class="hidden md:block w-1 h-1 bg-amber-500 rounded-full"></div>
                    <div class="flex items-center gap-2">
                        <i data-lucide="map-pin" class="w-4 h-4"></i>
                        <span class="preview-hero-location">{{ $invitation->data['venue_city'] ?? 'Udaipur, India' }}</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="grid md:grid-cols-2 gap-16 md:gap-24 items-center">
                ...
                <div class="reveal reveal-left group">
                    <div class="relative">
                        ...
                        <!-- REMOVED GRAYSCALE -->
                        <img src="{{ $invitation->data['gallery'][0] ?? 'https://images.unsplash.com/photo-1583939003579-730e3918a45a?auto=format&fit=crop&q=80&w=800' }}" class="relative z-10 w-full aspect-[3/4] object-cover transition-all duration-700 shadow-2xl hover:brightness-110" alt="The Bride">
                        
                        <div class="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-slate-950 to-transparent z-20">
                            <h3 id="bride-name" class="font-serif text-3xl text-white mb-1 preview-bride">{{ $invitation->data['bride_name'] ?? 'Elena Rossi' }}</h3>
                ...
                <div class="reveal reveal-right group">
                     <div class="relative">
                        ...
                        <!-- REMOVED GRAYSCALE -->
                        <img src="{{ $invitation->data['gallery'][1] ?? 'https://images.unsplash.com/photo-1595526114035-0d45ed16cfbf?auto=format&fit=crop&q=80&w=800' }}" class="relative z-10 w-full aspect-[3/4] object-cover transition-all duration-700 shadow-2xl hover:brightness-110" alt="The Groom">
                        
                        <div class="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-slate-950 to-transparent z-20">
                            <h3 id="groom-name" class="font-serif text-3xl text-white mb-1 preview-groom">{{ $invitation->data['groom_name'] ?? 'Julian Vance' }}</h3>
                            <div class="w-12 h-px bg-amber-500 mb-3"></div>
            ...
            <div class="relative timeline-line">
                ...
                <div class="relative pl-12 md:pl-0 md:grid md:grid-cols-2 md:gap-16 mb-20 reveal reveal-left">
                    <div class="md:text-right">
                        <div class="glass-dark p-8 rounded-xl border-l-2 border-amber-500 md:border-l-0 md:border-r-2 md:text-right hover:bg-slate-800/50 transition-colors">
                            <span class="text-amber-500 font-bold tracking-widest text-xs uppercase mb-2 block">Dec 11th • 10:00 AM</span>
                            <h4 class="font-serif text-2xl text-white mb-2">Haldi & Mehendi</h4>
                            <p class="text-sm text-slate-300 mb-4 font-light leading-relaxed">A morning filled with colors, turmeric, and henna designs. <br/><span class="text-amber-400">Dress code: Yellow & Bright Hues.</span></p>
                            <a href="https://maps.google.com" target="_blank" class="inline-flex items-center gap-2 text-xs text-amber-500 hover:text-white uppercase tracking-wider transition-colors">
                ...
                <div class="relative pl-12 md:pl-0 md:grid md:grid-cols-2 md:gap-16 mb-20 reveal reveal-right">
                    <div class="hidden md:block"></div>
                    <div>
                        <div class="glass-dark p-8 rounded-xl border-l-2 border-amber-500 hover:bg-slate-800/50 transition-colors">
                            <span class="text-amber-500 font-bold tracking-widest text-xs uppercase mb-2 block">Dec 11th • 07:00 PM</span>
                            <h4 class="font-serif text-2xl text-white mb-2">Sangeet Night</h4>
                            <p class="text-sm text-slate-300 mb-4 font-light leading-relaxed">An evening of music, dance performances, and glamour. <br/><span class="text-amber-400">Dress code: Indo-Western Glam.</span></p>
                ...
                <div class="relative pl-12 md:pl-0 md:grid md:grid-cols-2 md:gap-16 reveal reveal-left">
                    <div class="md:text-right">
                         <div class="glass-dark p-8 rounded-xl border-l-2 border-amber-500 md:border-l-0 md:border-r-2 md:text-right hover:bg-slate-800/50 transition-colors">
                            <span class="text-amber-500 font-bold tracking-widest text-xs uppercase mb-2 block">Dec 12th • 04:00 PM</span>
                            <h4 class="font-serif text-2xl text-white mb-2">Baraat & Pheras</h4>
                            <p class="text-sm text-slate-300 mb-4 font-light leading-relaxed">The royal procession followed by the sacred union under the stars. <br/><span class="text-amber-400">Dress code: Traditional Indian.</span></p>
                            <a href="#" class="inline-flex items-center gap-2 text-xs text-amber-500 hover:text-white uppercase tracking-wider transition-colors">
        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="columns-1 md:columns-3 gap-6 space-y-6">
                <div class="gallery-item reveal reveal-up">
                    <img src="{{ $invitation->data['gallery_1'] ?? 'https://images.unsplash.com/photo-1621621667797-e06afc217fb0?auto=format&fit=crop&q=80&w=800' }}" class="w-full rounded-lg shadow-lg hover:shadow-amber-500/20 transition-all duration-500 hover:scale-[1.02]" alt="Gallery Image">
                </div>
                <div class="gallery-item reveal reveal-up" style="transition-delay: 100ms;">
                    <img src="{{ $invitation->data['gallery_2'] ?? 'https://images.unsplash.com/photo-1583939003579-730e3918a45a?auto=format&fit=crop&q=80&w=800' }}" class="w-full rounded-lg shadow-lg hover:shadow-amber-500/20 transition-all duration-500 hover:scale-[1.02]" alt="Gallery Image">
                </div>
                <div class="gallery-item reveal reveal-up" style="transition-delay: 200ms;">
                    <img src="{{ $invitation->data['gallery_3'] ?? 'https://images.unsplash.com/photo-1595526114035-0d45ed16cfbf?auto=format&fit=crop&q=80&w=800' }}" class="w-full rounded-lg shadow-lg hover:shadow-amber-500/20 transition-all duration-500 hover:scale-[1.02]" alt="Gallery Image">
                </div>
                <div class="gallery-item reveal reveal-up">
                    <img src="{{ $invitation->data['gallery_4'] ?? 'https://images.unsplash.com/photo-1515934751635-c81c6bc9a2d8?auto=format&fit=crop&q=80&w=800' }}" class="w-full rounded-lg shadow-lg hover:shadow-amber-500/20 transition-all duration-500 hover:scale-[1.02]" alt="Gallery Image">
                </div>
                 <div class="gallery-item reveal reveal-up" style="transition-delay: 150ms;">
                    <img src="{{ $invitation->data['gallery_5'] ?? 'https://images.unsplash.com/photo-1610173824052-a56b3e71d378?auto=format&fit=crop&q=80&w=800' }}" class="w-full rounded-lg shadow-lg hover:shadow-amber-500/20 transition-all duration-500 hover:scale-[1.02]" alt="Gallery Image">
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- Footer -->
    <footer class="py-16 text-center bg-slate-950 border-t border-slate-900">
    ...
    <nav class="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-slate-900/90 backdrop-blur-xl border-t border-amber-500/20 flex justify-around items-center px-4 py-3 pb-6 shadow-[0_-10px_20px_rgba(0,0,0,0.5)] w-full max-w-full safe-pb">
        <button onclick="window.open('tel:+123456789')" class="flex flex-col items-center text-slate-400 hover:text-amber-400 transition-colors">
            <i data-lucide="phone" class="w-5 h-5"></i>
            <span class="text-[9px] mt-1 font-medium uppercase tracking-wider">Call</span>
        </button>
        <button onclick="window.open('https://wa.me/123456789')" class="flex flex-col items-center text-slate-400 hover:text-amber-400 transition-colors">
