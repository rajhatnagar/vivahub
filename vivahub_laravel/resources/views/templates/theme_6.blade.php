...
<body class="text-emerald-950 overflow-hidden" id="main-body">
            ...
            <div class="glass p-10 md:p-14 rounded-[30px] text-center border border-amber-300/20 shadow-2xl relative overflow-hidden backdrop-blur-xl animate-fade-in-up">
                ...
                <div class="relative z-10 space-y-6">
                    ...
                    <div class="space-y-3 py-4">
                        <h1 class="font-cinzel text-5xl md:text-7xl text-gradient-gold drop-shadow-md leading-tight pb-2">{{ $invitation->data['bride_name'] ?? 'Elena' }} & {{ $invitation->data['groom_name'] ?? 'Julian' }}</h1>
    ...
    <section class="relative h-[100dvh] w-full overflow-hidden flex flex-col md:flex-row">
        ...
        <div class="absolute inset-0 z-0">
            <img id="hero-bg" src="{{ $invitation->data['hero_image'] ?? 'https://images.unsplash.com/photo-1519741497674-611481863552?auto=format&fit=crop&q=80&w=2070' }}" 
                 alt="Wedding Decor" 
        ...
        <div class="relative z-10 flex flex-col justify-center items-center w-full h-full p-8 md:w-1/2 md:items-start md:pl-20">
            <div class="glass p-8 md:p-12 rounded-3xl max-w-lg text-center md:text-left space-y-6 animate-fade-in-up">
                ...
                <h1 class="font-cinzel text-5xl md:text-7xl text-emerald-900 leading-tight">
                    {{ $invitation->data['bride_name'] ?? 'Elena' }} <br/> <span class="text-gradient-gold font-decorative text-4xl md:text-6xl">&</span> <br/> {{ $invitation->data['groom_name'] ?? 'Julian' }}
                </h1>
                ...
                <div class="space-y-2 border-t border-emerald-100 pt-6">
                    <p class="flex items-center justify-center md:justify-start gap-2">
                        ...
                        {{ \Carbon\Carbon::parse($invitation->data['date'] ?? '2026-12-12')->format('F jS, Y') }}
                    </p>
                    <p class="flex items-center justify-center md:justify-start gap-2">
                        <i data-lucide="map-pin" class="w-4 h-4 text-rose-400"></i>
                        {{ $invitation->data['location'] ?? 'The Rosewood Estate, Udaipur' }}
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="grid md:grid-cols-2 gap-12">
                ...
                <div class="reveal reveal-left">
                    <div class="glass tilt-card p-4 rounded-[40px] transform hover:rotate-1 transition-transform duration-500">
                        <img src="{{ $invitation->data['bride_image'] ?? 'https://images.unsplash.com/photo-1616165415772-07873495d66c?auto=format&fit=crop&q=80&w=800' }}" class="w-full aspect-[4/5] object-cover rounded-[30px] mb-6 shadow-md" alt="The Bride">
                        <div class="p-4 text-center">
                            <h3 class="font-cinzel text-3xl text-emerald-900 mb-2">{{ $invitation->data['bride_name'] ?? 'Elena Rossi' }}</h3>
                ...
                <div class="reveal reveal-right">
                    <div class="glass tilt-card p-4 rounded-[40px] transform hover:-rotate-1 transition-transform duration-500">
                        <img src="{{ $invitation->data['groom_image'] ?? 'https://images.unsplash.com/photo-1596521575231-31a6907662c5?auto=format&fit=crop&q=80&w=800' }}" class="w-full aspect-[4/5] object-cover rounded-[30px] mb-6 shadow-md" alt="The Groom">
                        <div class="p-4 text-center">
                            <h3 class="font-cinzel text-3xl text-emerald-900 mb-2">{{ $invitation->data['groom_name'] ?? 'Julian Vance' }}</h3>
        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="columns-1 md:columns-2 gap-6 space-y-6">
                <div class="gallery-item reveal reveal-up">
                    <img src="{{ $invitation->data['gallery_1'] ?? 'https://images.unsplash.com/photo-1621621667797-e06afc217fb0?auto=format&fit=crop&q=80&w=800' }}" class="w-full rounded-3xl shadow-lg hover:shadow-2xl transition-shadow duration-300" alt="Gallery Image 1">
                </div>
                <div class="gallery-item reveal reveal-up" style="transition-delay: 100ms;">
                    <img src="{{ $invitation->data['gallery_2'] ?? 'https://images.unsplash.com/photo-1583939003579-730e3918a45a?auto=format&fit=crop&q=80&w=800' }}" class="w-full rounded-3xl shadow-lg hover:shadow-2xl transition-shadow duration-300" alt="Gallery Image 2">
                </div>
                <div class="gallery-item reveal reveal-up" style="transition-delay: 200ms;">
                    <img src="{{ $invitation->data['gallery_3'] ?? 'https://images.unsplash.com/photo-1595526114035-0d45ed16cfbf?auto=format&fit=crop&q=80&w=800' }}" class="w-full rounded-3xl shadow-lg hover:shadow-2xl transition-shadow duration-300" alt="Gallery Image 3">
                </div>
                <div class="gallery-item reveal reveal-up">
                    <img src="{{ $invitation->data['gallery_4'] ?? 'https://images.unsplash.com/photo-1515934751635-c81c6bc9a2d8?auto=format&fit=crop&q=80&w=800' }}" class="w-full rounded-3xl shadow-lg hover:shadow-2xl transition-shadow duration-300" alt="Gallery Image 4">
                </div>
                <div class="gallery-item reveal reveal-up" style="transition-delay: 150ms;">
                    <img src="{{ $invitation->data['gallery_5'] ?? 'https://images.unsplash.com/photo-1610173824052-a56b3e71d378?auto=format&fit=crop&q=80&w=800' }}" class="w-full rounded-3xl shadow-lg hover:shadow-2xl transition-shadow duration-300" alt="Gallery Image 5">
                </div>
            </div>
        </div>
    </section>
