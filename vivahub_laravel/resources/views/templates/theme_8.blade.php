...
<body class="selection:bg-orange-200 selection:text-orange-900" id="main-body">
    ...
    <section class="relative h-[100dvh] w-full overflow-hidden flex flex-col md:flex-row">
        <!-- Background -->
        <div class="absolute inset-0 z-0">
            <img id="hero-bg" src="{{ $invitation->data['hero_image'] ?? 'https://images.unsplash.com/photo-1511285560929-80b456fea0bc?auto=format&fit=crop&q=80&w=2070' }}" 
                 alt="VivaHub Wedding" 
            ...
            <div class="grid md:grid-cols-2 gap-16 items-center">
                ...
                <div class="reveal reveal-left group">
                    <div class="relative tilt-card">
                        ...
                        <div class="relative bg-white p-4 rounded-t-[150px] rounded-b-[20px] shadow-xl">
                            <!-- REMOVED GRAYSCALE -->
                            <img src="{{ $invitation->data['gallery'][0] ?? 'https://images.unsplash.com/photo-1515934751635-c81c6bc9a2d8?auto=format&fit=crop&q=80&w=800' }}" class="w-full aspect-[3/4] object-cover rounded-t-[140px] rounded-b-[10px] transition-all duration-700 hover:brightness-110" alt="The Bride">
                            <div class="text-center mt-6 mb-4">
                                <h3 id="bride-name" class="font-serif text-3xl text-orange-950 preview-bride">{{ $invitation->data['bride_name'] ?? 'Elena Rossi' }}</h3>
                ...
                <div class="reveal reveal-right group">
                     <div class="relative tilt-card">
                        ...
                        <div class="relative bg-white p-4 rounded-t-[150px] rounded-b-[20px] shadow-xl">
                            <!-- REMOVED GRAYSCALE -->
                            <img src="{{ $invitation->data['gallery'][1] ?? 'https://images.unsplash.com/photo-1520854222988-2d9638050689?auto=format&fit=crop&q=80&w=800' }}" class="w-full aspect-[3/4] object-cover rounded-t-[140px] rounded-b-[10px] transition-all duration-700 hover:brightness-110" alt="The Groom">
                            <div class="text-center mt-6 mb-4">
                                <h3 id="groom-name" class="font-serif text-3xl text-orange-950 preview-groom">{{ $invitation->data['groom_name'] ?? 'Julian Vance' }}</h3>
        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="columns-1 md:columns-3 gap-6 space-y-6">
                <div class="gallery-item reveal reveal-up">
                    <img src="{{ $invitation->data['gallery_1'] ?? 'https://images.unsplash.com/photo-1515934751635-c81c6bc9a2d8?auto=format&fit=crop&q=80&w=800' }}" class="w-full rounded-2xl shadow-md hover:shadow-xl transition-all duration-500 hover:scale-[1.02]" alt="Gallery">
                </div>
                <div class="gallery-item reveal reveal-up" style="transition-delay: 100ms;">
                    <img src="{{ $invitation->data['gallery_2'] ?? 'https://images.unsplash.com/photo-1583939003579-730e3918a45a?auto=format&fit=crop&q=80&w=800' }}" class="w-full rounded-2xl shadow-md hover:shadow-xl transition-all duration-500 hover:scale-[1.02]" alt="Gallery">
                </div>
                ...
                <div class="gallery-item reveal reveal-up">
                    <img src="{{ $invitation->data['gallery_3'] ?? 'https://images.unsplash.com/photo-1595526114035-0d45ed16cfbf?auto=format&fit=crop&q=80&w=800' }}" class="w-full rounded-2xl shadow-md hover:shadow-xl transition-all duration-500 hover:scale-[1.02]" alt="Gallery">
                </div>
                 <div class="gallery-item reveal reveal-up" style="transition-delay: 150ms;">
                    <img src="{{ $invitation->data['gallery_4'] ?? 'https://images.unsplash.com/photo-1610173824052-a56b3e71d378?auto=format&fit=crop&q=80&w=800' }}" class="w-full rounded-2xl shadow-md hover:shadow-xl transition-all duration-500 hover:scale-[1.02]" alt="Gallery">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-24 px-6 bg-[#fff8f0] relative">
        <div class="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
            <div class="reveal reveal-left">
                ...
                <h2 class="font-serif text-5xl mb-6 text-orange-950 preview-hero-location">{{ $invitation->data['venue_city'] ?? 'Udaipur, Rajasthan' }}</h2>
    ...
    <nav class="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-[#fff8f0]/90 backdrop-blur-xl border-t border-orange-900/10 flex justify-around items-center px-4 py-3 pb-6 shadow-[0_-10px_20px_rgba(0,0,0,0.05)] w-full max-w-full safe-pb">
        <button onclick="window.open('tel:+123456789')" class="flex flex-col items-center text-orange-900 hover:text-orange-700 transition-colors">
            <i data-lucide="phone" class="w-5 h-5"></i>
            <span class="text-[9px] mt-1 font-medium uppercase tracking-wider">Call</span>
        </button>
        <button onclick="window.open('https://wa.me/123456789')" class="flex flex-col items-center text-orange-900 hover:text-orange-700 transition-colors">
