...
<body class="selection:bg-teal-800 selection:text-amber-400" id="main-body">
    ...
    <section class="relative min-h-[100dvh] w-full flex flex-col items-center justify-center p-6 pt-24 pb-12 overflow-hidden">
        ...
        <div class="relative w-full max-w-4xl h-[70vh] flex items-center justify-center animate-fade-in-up">
            ...
            <div class="absolute inset-0 z-0 rounded-arch overflow-hidden border border-amber-500/20 shadow-2xl mx-auto w-full md:w-[60%] bg-teal-900">
                <img src="{{ $invitation->data['hero_image'] ?? 'https://images.unsplash.com/photo-1583939003579-730e3918a45a?auto=format&fit=crop&q=80&w=1600' }}" 
            ...
            <div class="relative z-10 text-center w-full mt-[20vh] md:mt-[30vh]">
                <div class="glass-modern p-6 md:p-12 mx-auto max-w-xl backdrop-blur-xl border-t border-amber-500/30">
                    ...
                    <div class="flex items-center justify-center gap-4 my-6">
                        ...
                        <p class="text-teal-200 text-sm tracking-widest uppercase preview-hero-date">{{ \Carbon\Carbon::parse($invitation->data['date'] ?? '2026-12-12')->format('F jS • Y') }}</p>
                        <div class="h-[1px] w-12 bg-white/20"></div>
                    </div>

                    <div class="flex justify-center gap-8 text-xs font-bold tracking-[0.2em] text-amber-400">
                        <span class="preview-hero-location">{{ strtoupper($invitation->data['venue_city'] ?? 'UDAIPUR') }}</span>
                        <span>•</span>
                        <span>INDIA</span>
                    </div>
                </div>
                ...
                <div class="reveal reveal-left group relative w-full md:w-[400px]">
                    <div class="relative h-[550px] rounded-t-[200px] border border-amber-500/20 p-2 transition-transform duration-500 hover:-translate-y-3 bg-[#042f2e]/50 backdrop-blur-sm">
                        <div class="h-full w-full rounded-t-[190px] overflow-hidden relative">
                            <!-- REMOVED GRAYSCALE -->
                            <img src="{{ $invitation->data['gallery'][0] ?? 'https://images.unsplash.com/photo-1509967419530-da38b4704bc6?auto=format&fit=crop&q=80&w=800' }}" 
                            ...
                            <div class="absolute bottom-10 left-0 right-0 text-center">
                                <h3 id="bride-name" class="font-serif text-4xl text-white mb-1 preview-bride">{{ $invitation->data['bride_name'] ?? 'Elena Rossi' }}</h3>
                ...
                <div class="reveal reveal-right group relative w-full md:w-[400px]">
                    <div class="relative h-[550px] rounded-b-[200px] border border-amber-500/20 p-2 transition-transform duration-500 hover:translate-y-3 bg-[#042f2e]/50 backdrop-blur-sm">
                        <div class="h-full w-full rounded-b-[190px] overflow-hidden relative">
                             <!-- REMOVED GRAYSCALE -->
                            <img src="{{ $invitation->data['gallery'][1] ?? 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&q=80&w=800' }}" 
                            ...
                            <div class="absolute top-10 left-0 right-0 text-center">
                                <h3 id="groom-name" class="font-serif text-4xl text-white mb-1 preview-groom">{{ $invitation->data['groom_name'] ?? 'Julian Vance' }}</h3>
    ...
    <!-- Gallery -->
    <section class="py-24 px-6 bg-[#042f2e]">
        <div class="max-w-6xl mx-auto">
            ...
            <div class="columns-1 md:columns-3 gap-6 space-y-6">
                <div class="gallery-item reveal reveal-up">
                    <img src="{{ $invitation->data['gallery_1'] ?? 'https://images.unsplash.com/photo-1515934751635-c81c6bc9a2d8?auto=format&fit=crop&q=80&w=800' }}" class="w-full transition-all duration-700 hover:scale-[1.02] hover:brightness-110" alt="Gallery">
                </div>
                <div class="gallery-item reveal reveal-up" style="transition-delay: 100ms;">
                    <img src="{{ $invitation->data['gallery_2'] ?? 'https://images.unsplash.com/photo-1583939003579-730e3918a45a?auto=format&fit=crop&q=80&w=800' }}" class="w-full transition-all duration-700 hover:scale-[1.02] hover:brightness-110" alt="Gallery">
                </div>
                <div class="gallery-item reveal reveal-up" style="transition-delay: 200ms;">
                    <div class="border border-amber-500/30 p-8 flex items-center justify-center text-center h-full min-h-[200px]">
                        <p class="font-script text-4xl text-amber-500">"Forever Begins"</p>
                    </div>
                </div>
                <div class="gallery-item reveal reveal-up">
                    <img src="{{ $invitation->data['gallery_3'] ?? 'https://images.unsplash.com/photo-1515934751635-c81c6bc9a2d8?auto=format&fit=crop&q=80&w=800' }}" class="w-full transition-all duration-700 hover:scale-[1.02] hover:brightness-110" alt="Gallery">
                </div>
                 <div class="gallery-item reveal reveal-up" style="transition-delay: 150ms;">
                    <img src="{{ $invitation->data['gallery_4'] ?? 'https://images.unsplash.com/photo-1610173824052-a56b3e71d378?auto=format&fit=crop&q=80&w=800' }}" class="w-full transition-all duration-700 hover:scale-[1.02] hover:brightness-110" alt="Gallery">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-24 px-6 bg-[#022c22] text-white relative">
        <div class="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center relative z-10">
            <div class="reveal reveal-left">
                ...
                <h2 class="font-serif text-5xl mb-6 preview-hero-location">{{ $invitation->data['venue_city'] ?? 'Udaipur, Rajasthan' }}</h2>
    ...
    <nav class="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-[#042f2e]/90 backdrop-blur-md flex justify-around items-center px-4 py-3 pb-6 border-t border-teal-800 w-full max-w-full safe-pb">
        <button onclick="window.open('tel:+123456789')" class="flex flex-col items-center text-teal-500 hover:text-amber-500 transition-colors">
            <i data-lucide="phone" class="w-5 h-5"></i><span class="text-[9px] mt-1 font-medium uppercase">Call</span>
        </button>
        <button onclick="window.open('https://wa.me/123456789')" class="flex flex-col items-center text-teal-500 hover:text-amber-500 transition-colors">
