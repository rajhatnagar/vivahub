        ...
        <div class="flex w-full lg:w-1/2 flex-col justify-center items-center px-6 py-12 lg:px-20 xl:px-32 bg-background-light dark:bg-background-dark transition-colors duration-300">
            <div class="w-full max-w-[480px] flex flex-col gap-6">
                ...
                <div class="w-full rounded-full bg-slate-200 dark:bg-slate-800 p-1.5 flex mt-4">
                    <a href="{{ route('login') }}" class="flex-1 cursor-pointer">
                ...
                <form class="flex flex-col gap-5 mt-2" method="POST" action="{{ route('register') }}">
                    ...
                    <div class="space-y-5">
                        ...
                        <label class="block space-y-2">
                         ...
                         <label class="block space-y-2">
                             <span class="text-sm font-semibold text-slate-900 dark:text-slate-200 ml-1">Confirm Password</span>
                            <div class="relative">
                                <input name="password_confirmation" required class="w-full rounded-full border border-slate-300 bg-white px-5 py-3.5 text-sm text-slate-900 placeholder:text-slate-400 focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20 dark:border-slate-700 dark:bg-slate-800 dark:text-white dark:placeholder:text-slate-500 transition-all" placeholder="Confirm your password" type="password"/>
                            </div>
                        </label>
                    </div>
                    <!-- Primary Button -->
                ...
                <p class="mt-4 text-center text-sm text-slate-500 dark:text-slate-400">
                    ...
                    <a class="font-bold text-primary hover:underline" href="{{ route('login') }}">Sign in</a>
                </p>
            </div>
        </div>
    </div>
