        ...
        <div class="glass-card-light rounded-2xl p-8 md:p-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
                ...
                <div>
                    ...
                    <ul class="space-y-4">
                        <li>
                            <a href="{{ url('/') }}" class="flex items-center gap-3 text-maroon/80 dark:text-champagne/80 hover:text-maroon dark:hover:text-gold transition-colors group">
                        ...
                        <li>
                            <a href="{{ route('about') }}" class="flex items-center gap-3 text-maroon/80 dark:text-champagne/80 hover:text-maroon dark:hover:text-gold transition-colors group">
                        ...
                        <li>
                            <a href="{{ route('features') }}" class="flex items-center gap-3 text-maroon/80 dark:text-champagne/80 hover:text-maroon dark:hover:text-gold transition-colors group">
                        ...
                        <li>
                            <a href="{{ route('templates') }}" class="flex items-center gap-3 text-maroon/80 dark:text-champagne/80 hover:text-maroon dark:hover:text-gold transition-colors group">
                        ...
                        <li>
                            <a href="{{ route('pricing') }}" class="flex items-center gap-3 text-maroon/80 dark:text-champagne/80 hover:text-maroon dark:hover:text-gold transition-colors group">
                        ...
                        <li>
                            <a href="{{ route('contact') }}" class="flex items-center gap-3 text-maroon/80 dark:text-champagne/80 hover:text-maroon dark:hover:text-gold transition-colors group">
                ...
                <div>
                    ...
                    <ul class="space-y-4">
                        <li>
                            <a href="{{ route('login') }}" class="flex items-center gap-3 text-maroon/80 dark:text-champagne/80 hover:text-maroon dark:hover:text-gold transition-colors group">
                        ...
                        <li>
                            <a href="{{ route('register') }}" class="flex items-center gap-3 text-maroon/80 dark:text-champagne/80 hover:text-maroon dark:hover:text-gold transition-colors group">
                        ...
                        <li>
                            <a href="{{ route('dashboard') }}" class="flex items-center gap-3 text-maroon/80 dark:text-champagne/80 hover:text-maroon dark:hover:text-gold transition-colors group">
                     ...
                     <ul class="space-y-4">
                        <li>
                            <a href="{{ route('privacy') }}" class="flex items-center gap-3 text-maroon/80 dark:text-champagne/80 hover:text-maroon dark:hover:text-gold transition-colors group">
